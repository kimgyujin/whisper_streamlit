...
if __name__ == "__main__":
    ...
    st.title("Whisper Streamlit")

    st.markdown(
        "Whisper Streamlit is an advanced transcription tool that converts speech from audio files, YouTube videos, or live input into text. Choose a mode and start transcribing!"
    )

    st.sidebar.markdown(
        """
        ## How to Use Whisper Streamlit:
